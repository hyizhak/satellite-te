...
# ========== Configurations ==========
ARG_TOPO_FILE_TEMPLATE = 'StarLink_DataSetForAgent100_500_T{}.pkl'
ARG_START_TOPO = 1
ARG_STOP_TOPO = 2
ARG_DATA_PER_TOPO = 500
...
parser.add_argument('--reduce-factor', type=int, required=True)

parser.add_argument('--start-topo', type=int, default=ARG_START_TOPO)
parser.add_argument('--stop-topo', type=int, default=ARG_STOP_TOPO)
...
StarlinkAdapter(
    ...
    topo_file_template=args.input_topo_file_template,
    reduce_factor=args.reduce_factor,
    start_topo=args.start_topo,
    stop_topo=args.stop_topo,
