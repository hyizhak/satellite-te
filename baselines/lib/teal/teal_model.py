...
class Teal():
    ...
    def train(self, epoch_num, batch_size, sample_num, save_per_epoch=False, epoch_model_path_template=None):
        """Train Teal model.
        ...
        for epoch in range(epoch_num):
            ...
            if save_per_epoch:
                self.actor.save_model(path=epoch_model_path_template.format(epoch))
