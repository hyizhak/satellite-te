...
class TealEnv(object):
    ...
    def __init__(
        ...
        self.edge_index, self.edge_index_values, self.p2e = \
            self.get_topo_matrix(problem_path, topo_idx, num_path, edge_disjoint, dist_metric)
    ...
    def get_path(self, problem_path, topo_idx, num_path, edge_disjoint, dist_metric):
        ...
        self.path_fname = path_fname = AssetManager.pathform_path(problem_path, topo_idx, num_path, edge_disjoint, dist_metric)
        ...
        try:
            ...
            problem_path, topo_idx, num_path, edge_disjoint, dist_metric)
    ...
    def compute_path(self, problem_path, topo_idx, num_path, edge_disjoint, dist_metric):
    ...
    def get_regular_path(self, problem_path, topo_idx, num_path, edge_disjoint, dist_metric):
        ...
        path_dict = self.get_path(problem_path, topo_idx, num_path, edge_disjoint, dist_metric)
    ...
    def get_topo_matrix(self, problem_path, topo_idx, num_path, edge_disjoint, dist_metric):
        """
