# This code is based on the GATConv implementation of DGL: https://github.com/dmlc/dgl/blob/master/python/dgl/nn/pytorch/conv/gatconv.py
# Modified on 05.02.2022: The original GAT implementation got extended by edge features.
# DGL is licensed under Apache 2.0.
# The full license is available in: LICENSE_DGL

"""Torch modules for graph attention networks with edge features (EdgeGAT)."""
