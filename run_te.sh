...
python teal.py --obj total_flow --tm-model toy --constellation Iridium --num-topo 300 --epochs 10 --admm-steps 2 --slice-train-start 0 --slice-train-stop 3360 --slice-val-start 3360 --slice-val-stop 4000 --slice-test-start 4000 --slice-test-stop 5000 --model-save True
