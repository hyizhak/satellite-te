...
python teal.py --obj total_flow --tm-model toy --constellation Iridium --num-topo 1 --epochs 10 --admm-steps 2 --slice-train-start 36 --slice-train-stop 148 --slice-val-start 148 --slice-val-stop 176 --slice-test-start 176 --slice-test-stop 196 --model-save True
