...
def benchmark(args):
    ...
    train, test, admm_test, supervised, panelized, dummy, loss = True, False, args.admm_test, args.supervised, args.penalized, args.dummy, args.loss

    print(f'Running SaTE with to retrive the topology embeddings')
...
def _sate_train_id(
    ...
    if supervised:
        ...
        train_mode = 'RL'
    return f'topoloy-GNN-embeddings'
